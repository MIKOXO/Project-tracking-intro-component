...
const Navbar = () => {
  ...
  return (
    <header className="mx-auto container py-10 px-4 lg:px-20">
      <nav className="flex flex-row items-center justify-between">
        ...
        <div className="sm:hidden">
          ...
          <div
            className={clsx(
              "shadow-xl rounded-xl w-full absolute px-6 py-4 top-28 right-0 items-center justify-center z-10 overflow-hidden",
              isOpen ? "flex" : "hidden"
            )}
          >
